...
// Check http://www.virtualradarserver.co.uk/Documentation/Formats/AircraftList.aspx to craft this query to your needs:
//const String QUERY_STRING = "lat=45.5231&lng=122.6765&fDstL=0&fDstU=10&fAltL=0&fAltL=250&fAltU=10000"; // Portland, OR
const String QUERY_STRING = "lat=40.7128&lng=-74.0059&fDstL=0&fDstU=10&fAltL=0&fAltL=250&fAltU=10000"; // New York, NY
